...
import 'package:knm_masjid_app/screens/category.dart';

//widgets
import 'package:knm_masjid_app/widgets/navbar.dart';
import 'package:knm_masjid_app/widgets/card-category.dart';

final Map<String, List<Map>> beautyCards = {
  "Music": [
    {
      "id": "artists",
      "title": "Artists",
      "image": images["beauty"]?["Artists"],
      "products": [
        {
          "img":
  ...
  "Clothes": [
    {
      "id": "fashion",
      "title": "Fashion",
      "image": images["beauty"]?["Fashion"],
      "products": [
        {
          "img":
              "https://images.unsplash.com/photo-1523979858672-687c4d4621a0?fit=crop&w=1333&q=80",
          "title": "Jackets",
          "description":
              "Best fashionable denim jackets you could find on the internet.",
          "price": "\$1500",
        },
        {
          "img":
              "https://images.unsplash.com/photo-1559526323-cb2f2fe2591b?fit=crop&w=1350&q=80",
          "title": "Shirts",
        ...
        {
          "img":
              "https://images.unsplash.com/photo-1530883374727-29c498f224c0?fit=crop&w=634&q=80",
          "title": "Dresses",
    ...
    },
    {
      "id": "garagesale",
      "title": "Garage Sale",
      "image": images["beauty"]?["Garage Sale"],
      "products": [
        {
          "img":
              "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?fit=crop&w=1350&q=80",
          "title": "General Clothes",
          "description":
              "The opening of this new local store came with a great impact on our community.",
          "price": "\$1500",
        },
        {
          "img":
              "https://images.unsplash.com/photo-1540221652346-e5dd6b50f3e7?fit=crop&w=1349&q=80",
          "title": "Jeans",
        ...
        {
          "img":
              "https://images.unsplash.com/photo-1465199549974-7d82de6e2830?fit=crop&w=1189&q=80",
          "title": "Scarfs",
          "description":
              "Any colour, any material, any brand. We got them all.",
          "price": "\$250",
        },
      ],
      "suggestions": [
    ...
    },
    {
      "id": "weddingdress",
      "title": "Wedding Dress",
      "image": images["beauty"]?["Wedding Dress"],
      "products": [
        {
          "img":
              "https://images.unsplash.com/photo-1546804784-896d0dca3805?fit=crop&w=1350&q=80",
        ...
        {
          "img":
              "https://images.unsplash.com/photo-1546193430-c2d207739ed7?fit=crop&w=689&q=80",
          "title": "Wedding services",
          "description":
              "We could help you out with your wedding planning, give us a try!",
          "price": "\$430",
        },
        {
          "img":
              "https://images.unsplash.com/photo-1541250848049-b4f7141dca3f?fit=crop&w=634&q=80",
          "title": "Wedding preparations",
          "description":
              "Count on us for the best wedding preparations of this year.",
          "price": "\$250",
        },
      ],
      "suggestions": [
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => Category(
                                      screenTitle: beautyCards[currentTag]
                                          ?[index]["title"],
