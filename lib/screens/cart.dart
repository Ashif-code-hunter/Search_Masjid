...
import 'package:knm_masjid_app/widgets/card-shopping-cart.dart';

//widgets
import 'package:knm_masjid_app/widgets/navbar.dart';
import 'package:knm_masjid_app/widgets/card-shopping.dart';
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () {
                                            ...
                                            setState(() {
                                              shoppingCards.add({
                                                "body": smallCards[index].title,
                                                "stock": true,
                                                "price": "180",
                                                "img": smallCards[index].img
                                              });
                                            });
                                          },
                                          child: Padding(
